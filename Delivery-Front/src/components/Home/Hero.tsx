      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 py-2 sm:px-6 lg:px-8">
        <div className="max-w-xl xl:pl-10">
          ...
          <p className="mb-8 max-w-md text-base leading-relaxed text-white/70">
            Fresh organic groceries, delivered straight to your door.
          </p>

          <div className="flex flex-wrap  gap-3">
            <a
              href="/products"
              className="inline-flex items-center gap-2 rounded-full bg-orange-400 px-7 py-3 font-semibold text-white transition-all hover:bg-orange-500 active:scale-[0.98]"
            >
              Shop Now
